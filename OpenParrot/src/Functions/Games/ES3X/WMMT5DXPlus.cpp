...
static int LoadGameData()
{
	...
	unsigned char settings[0x400];
	memset(settings, 0, 0x400);
	memcpy(settings, (void*)((imageBasedxplus + 0x01FD11B0) + 390 - 200), 0x400);
	writeDump("opensettings.bin", settings, 0x400);
