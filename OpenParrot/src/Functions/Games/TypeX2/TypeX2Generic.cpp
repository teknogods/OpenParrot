...
extern int(__fastcall* MultiHeadFixOri)(void* ECX, void* EDX);
extern int __fastcall MultiHeadFixHook(void* ECX, void* EDX);
...
static InitFunction initFunction([]()
{
	...
	if (GameDetect::currentGame == GameID::MusicGunGun2)
	{
		...
		MH_CreateHook((void*)(imageBase + 0x12E70), MultiHeadFixHook, (void**)&MultiHeadFixOri);
		if (!(ToBool(config["General"]["Windowed"])))
