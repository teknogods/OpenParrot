...
void SetCommandLineSFV()
{
	...
	{
		Args = L"\" -ResX=" + ResX + L" -ResY=" + ResY + L"\0";
	}
...
// Hide red error
const wchar_t* (WINAPI* nesicaErrorOrig)(__int64 a1, int a2, DWORD* a3);
const wchar_t* nesicaErrorHook(__int64 a1, int a2, DWORD* a3)
{
	return L"";
}
...
static InitFunction SFVFunc([]()
	{
		...
		{
			injector::MakeNOP(nesysbase + 0x1edaf, 3, true);
			MH_CreateHook((void*)(nesysbase + 0x1e850), nesicaErrorHook, (void**)&nesicaErrorOrig);
		}
